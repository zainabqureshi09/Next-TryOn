  ...
  return (
    <div className="overflow-hidden font-sans">
      ...
      >
        ...
        <div className="absolute top-0 left-0 w-64 h-64 bg-pink-500/20 rounded-full animate-pulse-slow blur-3xl -translate-x-1/2 -translate-y-1/2" />
        <div className="absolute bottom-0 right-0 w-72 h-72 bg-indigo-500/20 rounded-full animate-pulse-slow blur-3xl translate-x-1/2 translate-y-1/2" />
      </section>
      ...
      <section className="py-24 bg-gradient-to-b from-background to-surface">
        <h2 className="text-center text-4xl font-bold mb-12">{t("about.team")}</h2>
      ...
      <section className="py-24 bg-gradient-to-b from-surface to-background">
        <div className="text-center space-y-6 max-w-2xl mx-auto">
          ...
          <p className="text-lg text-muted-foreground">{t("about.contactDesc")}</p>
          <a
            href="/contact"
