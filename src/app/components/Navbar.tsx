...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-white/70 bg-white/90 border-b border-gray-200 shadow-sm">
      {/* Top Bar */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <Link href="/" className="flex items-center" aria-label="LensVision home">
            <VirtualTryOnLogo />
          </Link>
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.aside
            ...
            className="fixed right-0 top-0 bottom-0 w-72 h-full bg-white shadow-2xl md:hidden z-50 flex flex-col overflow-y-auto"
